    ...
    <main className="min-h-screen">
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center pb-20 self-end">
          ...
          <p className="text-xl md:text-2xl text-primary-foreground/90 mb-8 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
            Offering reliable and efficient land transport, Direct Freight Solutions ensures your cargo reaches its
            destination safely and on time. Trust in our expertise for streamlined logistics across various terrains.
          </p>
          ...
          <div className="flex flex-wrap gap-4 justify-center mb-8">
            <div className="flex items-center gap-2 bg-primary-foreground/10 backdrop-blur-sm px-4 py-2 rounded-full border border-primary-foreground/20">
              ...
              <span className="text-primary-foreground font-medium">5-Star Service</span>
            </div>
            <div className="flex items-center gap-2 bg-primary-foreground/10 backdrop-blur-sm px-4 py-2 rounded-full border border-primary-foreground/20">
            ...
            <div className="flex items-center gap-2 bg-primary-foreground/10 backdrop-blur-sm px-4 py-2 rounded-full border border-primary-foreground/20">
              ...
              <span className="text-primary-foreground font-medium">24/7 Support</span>
            </div>
          </div>
      ...
      <section className="py-20 bg-muted">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">Our track record speaks for itself</p>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Our Trusted Partners</h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/90 max-w-4xl mx-auto leading-relaxed">
              We believe that every mile matters, and every delivery reflects our commitment to excellence. From local
              routes to long-distance hauls, we combine dependable service, professional drivers, and modern equipment
              to keep your business moving forward — safely and on time.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <Card className="bg-primary-foreground/5 border-primary-foreground/20 backdrop-blur-sm hover:bg-primary-foreground/10 transition-all">
              <CardContent className="p-6 text-center">
                ...
                <div className="text-4xl md:text-5xl font-bold text-primary-foreground mb-2">99%</div>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-balance">Ready to Transform Your Logistics?</h2>
